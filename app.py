...
DOMANDE = [
    ...
    "19. Quando il gruppo lavora bene, il leader deve riconoscerlo apertamente.",
    ...
    "29. Il leader deve mostrarsi interessato ai problemi personali dei membri del gruppo.",
    "30. Il leader deve mostrare attenzione per il benessere dei membri del gruppo.",
    ...
    "37. Il leader deve fornire risposte oneste e obiettive ai membri del gruppo.",
